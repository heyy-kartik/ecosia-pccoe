  ...
  const features = [
    {
      ...
      description:
        "Our platform adapts to your learning style, providing personalized content and recommendations.",
    ...
    },
    {
      ...
      description:
        "Engage with immersive simulations and rich media content.",
    ...
    },
    {
      ...
      description:
        "Connect with peers and experts to discuss climate solutions.",
    ...
    },
    {
      title: "Global Impact",
      description:
        "See how your learning translates to real-world climate action.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From AI-driven personalization to global community engagement, our platform offers everything you need to master climate education.
        </p>
      </div>
